...
class Account:
    ...
    def deposit(self, amount):
        ...
        """
        t = Transaction(self.count, self.balance, self.balance + amount)
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            t = Transaction(self.count, self.balance, self.balance)
            self.count += 1
            self.transactions.append(t)
...
class Email:
    ...
    def __init__(self, msg, sender, recipient_name):
        self.msg = msg
        self.sender = Client(Server(), sender)
